...
function publicView(data, type, token) {
  ...
  const publicSettings = Object.fromEntries(['name','studio','studioName','username','store_slug','logo','logoDark','logoLight','avatar','accent','accentColor','accent2','accentColor2','theme_color','displayMode','display_mode','phone','email','whatsapp','about','bio','currency','socialLinks','social_links'].filter(key => settings[key] !== undefined).map(key => [key, settings[key]]));
